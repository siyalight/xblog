<div class="widget widget-user" style="overflow: hidden">
    <div class="widget-user-header" style="background: url('{{ $profile_image or '' }}') center center;">
        ...
        <h5 class="widget-user-desc">{{ $description or '' }}</h5>
    </div>
        ...
        <div class="row">
            <div class="col-sm-3 border-right">
                <div class="description-block">
                    <a href="{{ config('social.weibo') }}" class="description-header"><i class="fa fa-weibo fa-lg" aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-sm-3 border-right">
                <div class="description-block">
            ...
            <div class="col-sm-3 border-right">
                <div class="description-block">
                    <a href="{{ config('social.facebook') }}" class="description-header"><i class="fa fa-facebook-official fa-lg"
                                                              aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="description-block">
                    <a href="{{ config('social.twitter') }}" class="description-header"><i class="fa fa-twitter fa-lg" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div>
