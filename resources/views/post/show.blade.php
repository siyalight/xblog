...
@section('content')
    <div class="container">
        <div class="row">
            <div id="post-detail-wrap" class="col-md-9 col-sm-12">
            ...
            <div id="post-navigation-wrap" class="col-md-3 hidden-sm">
                <div id="post-navigation" class="widget widget-default">
                    <div class="widget-header">
                        <p class="post-navigation-title">文章目录</p>
                    </div>
                    <div class="widget-body" id="navigation-body">
                    </div>
                </div>
            </div>
        </div>
        <div class="row  mt-30">
            <div id="comment-wrap" class="col-md-9 col-sm-12">
